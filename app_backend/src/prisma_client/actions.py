...
class UserActions(Generic[_PrismaModelT]):
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second User record ordered by the college field
...
class EventActions(Generic[_PrismaModelT]):
    ...
    async def query_first(
        ...
        *args
        ...
        user = await Event.prisma().query_first(
            'SELECT * FROM Event WHERE event_host = $1',
            'caaaedabfc',
        )
        ```
        """
    ...
    async def create(
        ...
        event = await Event.prisma().create(
            data={
                ...
                'event_host': 'bigibebcib',
                'event_name': 'bigaiehgcc',
                'event_description': 'beeifcbebf',
                'event_init_date': datetime.datetime.utcnow(),
                'event_end_date': datetime.datetime.utcnow(),
                'event_location': 'bgcigfahea',
            },
        )
        ```
        """
        ...
        *,
        ...
        total = await Event.prisma().create_many(
            data=[
                {
                    # data to create a Event record
                    'event_host': 'bcejgaggif',
                    'event_name': 'idfjadbcc',
                    'event_description': 'hgdhbjhhj',
                    'event_init_date': datetime.datetime.utcnow(),
                    'event_end_date': datetime.datetime.utcnow(),
                    'event_location': 'ecjjjfbae',
                },
                {
                    # data to create a Event record
                    'event_host': 'bhhfibbigf',
                    'event_name': 'ijdbeffgg',
                    'event_description': 'jjfeafhfj',
                    'event_init_date': datetime.datetime.utcnow(),
                    'event_end_date': datetime.datetime.utcnow(),
                    'event_location': 'cbachdgfce',
                },
            ],
            skip_duplicates=True,
        )
    ...
    async def find_many(
        ...
        # find the first 5 Event records ordered by the event_name field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Event record ordered by the event_description field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Event record ordered by the event_init_date field
        event = await Event.prisma().find_first_or_raise(
            skip=1,
            order={
                'event_init_date': 'desc',
            },
        )
        ```
        """
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Event records by created_at values
        # and count how many records are in each group
